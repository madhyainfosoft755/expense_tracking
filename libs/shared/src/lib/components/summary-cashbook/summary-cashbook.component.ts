...
@Component({
  selector: 'lib-summary-cashbook',
  templateUrl: './summary-cashbook.component.html',
  standalone: true,
  imports: [CommonModule, TableModule, ButtonModule, FormsModule, MultiSelectModule, SelectModule, BreadcrumbModule],
  styles: ``
})
export class SummaryCashbookComponent implements OnInit {
    ...
    loadSummaryData(): void {
        ...
        this.commonApiService.getSummaryCashbook(data).subscribe({
            next: (res) => {
                // this.data = res.cashbook_summary_data;
                this.data = res.cashbook_summary_data.map((item: any) => {
    ...
    exportToCSV() {
        ...
        this.helperSharedService.exportToCSV(csvRows, 'summary_cashbook');
