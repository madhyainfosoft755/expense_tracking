...
@Component({
  selector: 'lib-shared-cashbook-expense-summary',
  imports: [CommonModule, TableModule, MultiSelectModule, FormsModule, SelectModule, ButtonModule],
  templateUrl: 'cashbook-expense-summary.component.html',
  styles: [],
  encapsulation: ViewEncapsulation.None,
})
export class CashbookExpenseSummaryComponent implements OnInit {
    ...
    expenseSummary(){
      ...
      //   "sort_order": "desc"
      // }
      this.commonApiService.expenseSummaryData(data)
      .subscribe({
          next: (res: any) => {
              this.expenseSummaryData = res;
